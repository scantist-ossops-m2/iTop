...
use Combodo\iTop\Controller\CSVImport;
...
try {
	...
	function ProcessCSVData(WebPage $oPage, $bSimulate = true)
	{
		...
		return CSVImport::_ProcessCSVData($iBoxSkipLines, $iNbSkippedLines, $sDateTimeFormat, $sCustomDateTimeFormat, $sSynchroScope, $sClassName, $oPage, $aSynchroUpdate, $sCSVData, $sSeparator, $sTextQualifier, $bHeaderLine, $aResult, $aSearchFields, $aFieldsMapping, $bSimulate,
			$sCSVDataTruncated, $iCurrentStep,
			$sEncoding, $bAdvanced);
